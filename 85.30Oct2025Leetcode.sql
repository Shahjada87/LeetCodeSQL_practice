...
create table if not exists 76LatestLoginIn2020_1890(
    user_id int,
    time_stamp datetime,
    primary key (user_id, time_stamp)
);

insert into 76LatestLoginIn2020_1890 values
...
mysql> select * from 76LatestLoginIn2020_1890;
+---------+---------------------+
| user_id | time_stamp          |
+---------+---------------------+
|       2 | 2019-08-25 07:59:08 |
