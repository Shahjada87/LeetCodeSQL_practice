...
Create table if not exists 21DailyLeadsPartners1693(
    date_id date,
...
Insert into 21DailyLeadsPartners1693 values 
...
mysql> select * from 21DailyLeadsPartners1693;
+------------+-----------+---------+------------+
