...
create table if not exists 54The2020LatestLogin1890(
    user_id int,
    timeStamp datetime,
...
insert into 54The2020LatestLogin1890 values 
...
mysql> select * from 54The2020LatestLogin1890;
+---------+---------------------+
| user_id | timeStamp           |
+---------+---------------------+
|       2 | 2019-08-25 07:59:08 |
