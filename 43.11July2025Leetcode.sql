...
create table if not exists 35ReformatDepartmentTable1179(
    id int,
    revenue int,
    month varchar(50)
);

insert into 35ReformatDepartmentTable1179 values
(1, 8000, 'Jan'),
(2, 9000, 'Jan'),
(3, 10000, 'Feb'),
(1, 7000, 'Feb'),
...
mysql> select * from 35ReformatDepartmentTable1179;
+------+---------+-------+
| id   | revenue | month |
+------+---------+-------+
|    1 |    8000 | Jan   |
...
from 35ReformatDepartmentTable1179
group by id
