...
create table if not exists 58PrimaryDepartmentForEmployee1789(
    employee_id int ,
    department_id int,
...
insert into 58PrimaryDepartmentForEmployee1789 values
(1, 1, 'N'),
(2, 1, 'Y'),
(2, 2, 'N'),
(3, 3, 'N'),
...
mysql> select * from 58PrimaryDepartmentForEmployee1789;
+-------------+---------------+--------------+
...
From 58PrimaryDepartmentForEmployee1789  
